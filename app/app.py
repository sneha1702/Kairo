...
with tab_kairo:
    REMOVE_PLACEHOLDER = True
        ...
        .kn-brand-icon { font-size: 21px; line-height: 1; }
        .kn-links {
          display: flex;
          align-items: center;
          gap: 30px;
        ...
        .kn-link:hover { color: var(--ink); text-decoration: none; }
        .kn-cta {
          display: inline-flex;
          align-items: center;
          gap: 6px;
        ...
        .kh-h1 em { font-style: normal; color: var(--accent); }
        .kh-sub {
          font-size: 16.5px;
          line-height: 1.7;
          color: var(--ink-2);
        ...
        .kh-card {
          ...
          border: 1px solid var(--hairline);
          border-radius: 16px;
          box-shadow: 0 4px 28px oklch(0.5 0.02 60 / 0.11);
          padding: 14px 16px;
        }
        .kh-card-label {
          font-family: var(--font-mono);
        ...
        <nav class="kn">
          <a class="kn-brand" href="#">
            <span class="kn-brand-icon">🔮</span>
            <span>Kairo</span>
          </a>
          <div class="kn-links">
            <a class="kn-link" href="#">Intelligence</a>
            <a class="kn-link" href="#">Markets</a>
            <a class="kn-link" href="#">Narratives</a>
            <a class="kn-link" href="#">History</a>
          </div>
          <a class="kn-cta" href="#">Explore Now &rarr;</a>
        </nav>
        ...
        <section class="kh">
          ...
          <!-- Left: copy -->
          <div>
            <div class="kh-eyebrow">🔮 Kairo &nbsp;&middot;&nbsp; Crypto Intelligence</div>
            <h1 class="kh-h1">
              The market signals<br>
              insiders act on.<br>
              <em>Now in plain English.</em>
            </h1>
            <p class="kh-sub">
              Kairo reads on-chain flows, tracks whale movements, and surfaces
              emerging narratives — then translates everything into clear,
              jargon-free insights. HNI-grade intelligence, built for everyone.
            </p>
            <ul class="kh-checks">
              <li><span class="kh-tick">&#10003;</span>Real-time on-chain data &amp; whale signals</li>
              <li><span class="kh-tick">&#10003;</span>AI-powered narrative detection across chains</li>
              <li><span class="kh-tick">&#10003;</span>No Bloomberg terminal. No research desk.</li>
            </ul>
            <a class="kh-cta" href="#">Explore Intelligence &rarr;</a>
          </div>
          ...
          <div class="kh-right">
            <div class="kh-cards">
              ...
              <!-- Background blobs -->
              <svg style="position:absolute;inset:0;width:100%;height:100%;z-index:0;overflow:visible" viewBox="0 0 340 340" fill="none">
                <circle cx="210" cy="170" r="140" fill="oklch(0.92 0.045 50)" opacity="0.40"/>
                <circle cx="130" cy="220" r="85"  fill="oklch(0.92 0.045 50)" opacity="0.22"/>
              </svg>

              <!-- Card 1: Narrative (main, upper-left) -->
              <div class="kh-card" style="top:32px;left:8px;width:196px;z-index:3;transform:rotate(-1.2deg)">
                <div class="kh-card-label">🧠 Narrative Detected</div>
                <div class="kh-card-val" style="font-size:15px">DeFi Renaissance</div>
                <div class="kh-card-sub">Confidence &nbsp;87%</div>
                <span class="kh-tag">Strengthening &#8593;</span>
              </div>

              <!-- Card 2: Whale Alert (upper-right) -->
              <div class="kh-card" style="top:8px;right:4px;width:162px;z-index:4;transform:rotate(1.6deg)">
                <div class="kh-card-label">🐳 Whale Alert</div>
                <div class="kh-card-val">$48.2M</div>
                <div class="kh-card-sub">BTC inflow &middot; 3 wallets</div>
              </div>

              <!-- Card 3: Chart (lower-left) -->
              <div class="kh-card" style="bottom:28px;left:18px;width:238px;z-index:3;transform:rotate(0.6deg)">
                <div class="kh-card-label">📈 On-chain Volume</div>
                <svg viewBox="0 0 208 48" style="width:100%;height:48px;margin:6px 0 2px">
                  <defs>
                    <linearGradient id="cg" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stop-color="oklch(0.64 0.124 42)" stop-opacity="0.25"/>
                      <stop offset="100%" stop-color="oklch(0.64 0.124 42)" stop-opacity="0"/>
                    </linearGradient>
                  </defs>
                  <polygon points="0,40 34,32 68,37 104,17 138,21 174,9 208,13 208,48 0,48"
                    fill="url(#cg)"/>
                  <polyline points="0,40 34,32 68,37 104,17 138,21 174,9 208,13"
                    stroke="oklch(0.64 0.124 42)" stroke-width="2.2" fill="none"
                    stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <div class="kh-card-sub" style="text-align:right;font-family:var(--font-mono);font-size:11px">+24.7% &nbsp;&#183;&nbsp; 7d</div>
              </div>

              <!-- Card 4: Smart Money signal (lower-right) -->
              <div class="kh-card" style="bottom:8px;right:8px;width:130px;z-index:5;transform:rotate(-1.4deg)">
                <div class="kh-card-label">⚡ Signal</div>
                <div class="kh-card-val" style="font-size:13px">Smart Money<br>Accumulating</div>
                <span class="kh-tag-green">Active now</span>
              </div>
